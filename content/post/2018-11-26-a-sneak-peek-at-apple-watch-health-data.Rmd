...
But I'm not satisfied with theme somehow, so I decide to experiment a little bit on a [FiveThirtyEight-style theme](https://github.com/jrnold/ggthemes/blob/master/R/fivethirtyeight.R). It is a more furnished theme, but does not match the Activity app palette. Well, I just cannot reject the attraction of minimalism.

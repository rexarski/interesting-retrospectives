...
knitr::opts_chunk$set(fig.path='../img/westerosi/', dev = 'png', 
                      # out.width='480px',
...
```{r}
img1 <- rasterGrob(as.raster(readPNG("../img/westerosi/trace1.png")), interpolate = FALSE)
img2 <- rasterGrob(as.raster(readPNG("../img/westerosi/trace2.png")), interpolate = FALSE)
...
```{r}
grid.raster(readPNG("../img/westerosi/acf.png"))
```
...
```{r}
img1 <- rasterGrob(as.raster(readPNG("../img/westerosi/pred1.png")), interpolate = FALSE)
img2 <- rasterGrob(as.raster(readPNG("../img/westerosi/pred2.png")), interpolate = FALSE)
...
```{r}
img1 <- rasterGrob(as.raster(readPNG("../img/westerosi/surv1.png")), interpolate = FALSE)
img2 <- rasterGrob(as.raster(readPNG("../img/westerosi/surv2.png")), interpolate = FALSE)
img3 <- rasterGrob(as.raster(readPNG("../img/westerosi/surv3.png")), interpolate = FALSE)
...
```{r}
grid.raster(readPNG("../img/westerosi/got-meme.png"))
```
